...
@section('content')
    ...
    <div class="container">
        <div class="mt-5">
            <h2 style="font-weight: 600"> চ্যারিটি ফোরাম</h2>
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-12 pt-4 text-center">
                <img src="/site_image/WA0001.jpg" alt="Girl in a jacket" width="350" >
                <br/>
                <br/>
                <img src="/site_image/WA0005.jpg" alt="Girl in a jacket" width="350" >
            </div>
        </div>
        <hr>
