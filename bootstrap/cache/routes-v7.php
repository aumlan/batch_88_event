1617)|update/([^/]++)(*:1641)|edit/([^/]++)(*:1663))|s(?|lider/(?|update/([^/]++)(*:1701)|delete/([^/]++)(*:1725))|oftware/delete/([^/]++)(*:1758))|pro(?|duct/(?|update/([^/]++)(*:1797)|delete/(?|([^/]++)(*:1824)|image/([^/]++)(*:1847))|edit/([^/]++)(*:1870)|view/([^/]++)(*:1892)|category/([^/]++)(*:1918)|attribute/configure/(?|([^/]++)(*:1958)|store/([^/]++)(*:1981)|1(*:1991)|2(*:2001)))|file/update/([^/]++)(*:2032))|attribute/delete/([^/]++)(*:2067)|order/(?|edit/([^/]++)(*:2098)|view/([^/]++)(*:2120)|delete/([^/]++)(*:2144)|updateOrderStatus/([^/]++)(*:2179))|user/delete/([^/]++)(*:2209)))/?$}sDu',
    ),
    3 => 
    array (
      34 => 
  ...
  array (
    ...
    return $request->user();
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"0000000028b3d5e80000000052350de2";}";s:4:"hash";s:44:"6DmaZHEDyB6x8EMFXgnKSugq4MMmaWCGiFdANkKYOq4=";}}',
        'namespace' => 'App\\Http\\Controllers',
        'prefix' => 'api',
        'where' => 
        array (
        ),
        'as' => 'generated::jQOE7BVSJBunJtfh',
      ),
      'fallback' => false,
      'defaults' => 
      array (
...
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"0000000028b3d5ea0000000052350de2";}";s:4:"hash";s:44:"E0EezVgsYch57gVeAtRgpXfzGBEX9pLZwTgSNchVpSs=";}}',
        'namespace' => 'App\\Http\\Controllers',
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'generated::BpvRShmHcQBMMHnt',
      ),
      'fallback' => false,
      'defaults' => 
      array (
...
}";s:5:"scope";s:37:"Illuminate\\Routing\\RouteFileRegistrar";s:4:"this";N;s:4:"self";s:32:"0000000028b3d5ec0000000052350de2";}";s:4:"hash";s:44:"bDaGkquaX4AQyF70YXDVaikerM1w1zt1CDnENz+e9Mg=";}}',
        'namespace' => 'App\\Http\\Controllers',
        'prefix' => '',
        'where' => 
        array (
        ),
        'as' => 'generated::xJrpk1GiHUDgyLhj',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Frontend\\HomeController@user_registration',
        'controller' => 'App\\Http\\Controllers\\Frontend\\HomeController@user_registration',
        'namespace' => 'App\\Http\\Controllers',
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Frontend\\HomeController@user_message',
        'controller' => 'App\\Http\\Controllers\\Frontend\\HomeController@user_message',
        'namespace' => 'App\\Http\\Controllers',
        'prefix' => '',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Backend\\User\\UserController@contact',
        'controller' => 'App\\Http\\Controllers\\Backend\\User\\UserController@contact',
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Backend\\User\\UserController@destroyContact',
        'controller' => 'App\\Http\\Controllers\\Backend\\User\\UserController@destroyContact',
